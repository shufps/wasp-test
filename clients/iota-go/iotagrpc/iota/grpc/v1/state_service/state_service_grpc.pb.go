...
const (
	StateService_ListDynamicFields_FullMethodName = "/iota.grpc.v1.state_service.StateService/ListDynamicFields"
	StateService_ListOwnedObjects_FullMethodName  = "/iota.grpc.v1.state_service.StateService/ListOwnedObjects"
	StateService_GetCoinInfo_FullMethodName       = "/iota.grpc.v1.state_service.StateService/GetCoinInfo"
)
...
func (UnimplementedStateServiceServer) ListDynamicFields(context.Context, *ListDynamicFieldsRequest) (*ListDynamicFieldsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListDynamicFields not implemented")
}
func (UnimplementedStateServiceServer) ListOwnedObjects(context.Context, *ListOwnedObjectsRequest) (*ListOwnedObjectsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListOwnedObjects not implemented")
}
func (UnimplementedStateServiceServer) GetCoinInfo(context.Context, *GetCoinInfoRequest) (*GetCoinInfoResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetCoinInfo not implemented")
}
...
var StateService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "iota.grpc.v1.state_service.StateService",
	...
	Metadata: "iota/grpc/v1/state_service.proto",
}
